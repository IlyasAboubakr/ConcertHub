<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Add Ticket Type to: ') . $event->title }}
        </h2>
    </x-slot>
            ...
            <div class="p-6 bg-white shadow sm:rounded-lg max-w-2xl mx-auto">
                ...
                <form method="POST" action="{{ route('organizer.tickets.store', $event) }}">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="quantity_available" class="block mt-1 w-full" type="number" step="1" name="quantity_available" :value="old('quantity_available')" required />
